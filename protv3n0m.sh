#!/bin/bash
# ShellPhish v1.7
# Coded by: Simanta <<mrv3n0m>>
# This script uses some Phishing Pages 
...
printf "\e[1;77m   ██║╚██╔╝██║██╔══██╗   ╚██╗ ██╔╝ ╚═══██╗██║╚██╗██║████╔╝██║██║╚██╔╝██║  \e[0m\n"
printf "\e[1;77m   ██║ ╚═╝ ██║██║  ██║    ╚████╔╝ ██████╔╝██║ ╚████║╚██████╔╝██║ ╚═╝ ██║  \e[0m\n"
printf "\e[1;77m   ╚═╝     ╚═╝╚═╝  ╚═╝     ╚═══╝  ╚═════╝ ╚═╝  ╚═══╝ ╚═════╝ ╚═╝     ╚═╝  v1.7\e[0m\n"
printf "\e[1;77m              Simanta <MR V3N0m > Idea By Prottasha                       \e[0m\n"  
printf "\n"
printf "\e[1;93m       .:.:.\e[0m\e[1;77m Phishing Tool coded by: MRV3N0M {Simanta} \e[0m\e[1;93m.:.:.\e[0m\n"
printf "\n"
printf "  \e[1;77m:: Hey dude ..Im simanta <MR v3n0m> Remember me ITX V3N0m BRAH  ::\e[0m\n"
printf "  \e[1;77m:: THIS TOOL IS SPECIALY MADE FOR Phissing<< Idea From Prottasha >> ::\e[0m\n"
printf "  \e[1;77m:: Responsible for any misuse or damage caused by Simanta::\e[0m\n"
printf "\n"
}
